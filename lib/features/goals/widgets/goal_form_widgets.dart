...
class GoalSheets {
                          ...
                          for (final cat in GoalCategory.values) ...[
                            Padding(
                              ...
                              child: _SheetChip(
                                label: cat.label,
                                selected:
                                    selectedCat == cat && customTag == null,
                    ...
                    child: FilledButton(
                      onPressed: () {
                        if (ctrl.text.trim().isNotEmpty) {
                          ...
                          ref
                              .read(tierGoalsRepoProvider(tier))
                              ?.update(
                                Goal(
                                  id: goal.id,
  ...
  static void showAdd(
    ...
    GoalCategory? selectedCat = tier == GoalTier.long
                    ...
                    onTap: () async {
                      ...
                      await showModalBottomSheet<void>(
                        ...
                        builder: (_) => AiGoalPlanSheet(
                          ...
                          onConfirm: (confirmed) {
                            final desc = descCtrl.text.trim();
                            final rootRepo = ref.read(
                              tierGoalsRepoProvider(tier),
                            );
                            rootRepo
                                ?.add(
                                  title: title,
